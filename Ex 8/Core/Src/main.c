...
int main(void)
{
  ...
  HAL_TIM_Encoder_Start(&htim3, TIM_CHANNEL_ALL);	// start the quadrature encoder (timer3)
  /* USER CODE END 2 */
...
static void MX_TIM3_Init(void)
{
  ...
  __HAL_TIM_ENABLE_IT(&htim3, TIM_IT_UPDATE);		// enable timer update interrupt source
